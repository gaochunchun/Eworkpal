package com.mainiway.autolayout.config;

import android.content.Context;
import android.content.pm.ApplicationInfo;
import android.content.pm.PackageManager;

import com.mainiway.autolayout.utils.L;
import com.mainiway.autolayout.utils.ScreenUtils;
...
public class AutoLayoutConifg
{
    ...
    public void checkParams()
    {
        if (mDesignHeight <= 0 || mDesignWidth <= 0)
        {
            throw new RuntimeException(
                    "Please check the AutoLayout ,you must set " + KEY_DESIGN_WIDTH + " and " + KEY_DESIGN_HEIGHT + "  in your manifest file.");
        }
    }
    ...
    private void getMetaData(Context context)
    {
        ...
        {
            throw new RuntimeException(
                    "Please check the AutoLayout ,you must set " + KEY_DESIGN_WIDTH + " and " + KEY_DESIGN_HEIGHT + "  in your manifest file.", e);
        }
