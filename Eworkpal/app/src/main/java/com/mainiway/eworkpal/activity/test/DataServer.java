...
public class DataServer {
    ...
    private static final String CYM_CHAD = "gao_chun";
    ...
    public static List<Status> getSampleData(int lenth) {
        ...
        for (int i = 0; i < lenth; i++) {
            ...
            status.setUserName("gao_chun" + i);
            status.setCreatedAt("11/25/" + i);
            status.setRetweet(i % 2 == 0);
            status.setUserAvatar("https://avatars1.githubusercontent.com/u/11451672?v=3&s=460");
            status.setText("https://github.com/gaochunchun");
            list.add(status);
        }
        return list;
    }
